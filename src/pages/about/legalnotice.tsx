    ...
    <div>
      ...
      <div className="legalNotice">
        ...
        <p>
          ...
          contact us by email at aidforanimals@gmail.com. Our Disclaimer was generated with the help of the{' '}
          <a href="https://www.disclaimergenerator.net/">Free Disclaimer Generator</a>.
        </p>

        <h2>Disclaimers for Aid For Animals</h2>

        <p>
          All the information on this website - www.https://aidforanimals.fr - is published in good faith and for
          general information purpose only. Aid For Animals does not make any warranties about the completeness,
          reliability and accuracy of this information. Any action you take upon the information you find on this
          website (Aid For Animals), is strictly at your own risk. Aid For Animals will not be liable for any losses
